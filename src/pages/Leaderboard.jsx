      ...
      <AnimatePresence>
        {error && (
          <motion.div 
            ...
            className="p-10 nv-card border-nuvio-red/20 bg-nuvio-red/5 text-center max-w-2xl mx-auto"
          >
             <AlertCircle className="w-12 h-12 text-nuvio-red mx-auto mb-4" />
             <h3 className="text-xl font-black text-white uppercase tracking-tighter">Connection Interrupted</h3>
             <p className="text-xs text-text-muted font-bold uppercase tracking-widest mt-2">{error}</p>
          </motion.div>
        )}
      </AnimatePresence>
        ...
        <div className="nv-card p-0 border-white/5 max-w-5xl mx-auto overflow-hidden shadow-2xl">
           ...
           <div className="divide-y divide-white/5">
              ...
              {peers.length === 0 && !loading && (
                <div className="p-20 text-center opacity-30 italic text-xs uppercase font-bold tracking-widest">No scholars found in the matrix...</div>
              )}
           </div>
        </div>
      )}
